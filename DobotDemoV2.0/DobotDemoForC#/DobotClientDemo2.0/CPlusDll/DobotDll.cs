...
namespace DobotClientDemo.CPlusDll
{
    ...
    public class DobotDll
    {
        ...
        [DllImport("DobotDll.dll", EntryPoint = "SetDeviceWithL", CallingConvention = CallingConvention.Cdecl)]
        public static extern int SetDeviceWithL(bool isEnable, bool isQueued, ref UInt64 queuedCmdIndex);
        [DllImport("DobotDll.dll", EntryPoint = "GetDeviceWithL", CallingConvention = CallingConvention.Cdecl)]
        public static extern int GetDeviceWithL(bool isWithL);
        [DllImport("DobotDll.dll", EntryPoint = "GetPoseL", CallingConvention = CallingConvention.Cdecl)]
        public static extern int GetPoseL( ref float  l);
        [DllImport("DobotDll.dll", EntryPoint = "SetPTPLParams", CallingConvention = CallingConvention.Cdecl)]
        public static extern int SetPTPLParams(ref PTPLParams pTPLParams, bool isQueued, ref UInt64 queuedCmdIndex);    
        [DllImport("DobotDll.dll", EntryPoint = "SetPTPWithLCmd", CallingConvention = CallingConvention.Cdecl)]
        public static extern int SetPTPWithLCmd(ref PTPWithLCmd ptpWithLCmd, bool isQueued, ref UInt64 queuedCmdIndex);
        ...
        [DllImport("DobotDll.dll", EntryPoint = "SetJOGLParams", CallingConvention = CallingConvention.Cdecl)]
        public static extern int SetJOGLParams(ref JogLParams jogLParams, bool isQueued, ref UInt64 queuedCmdIndex);
