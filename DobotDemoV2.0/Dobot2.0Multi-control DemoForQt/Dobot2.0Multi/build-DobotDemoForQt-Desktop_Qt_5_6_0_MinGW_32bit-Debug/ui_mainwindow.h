...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        combox1 = new QComboBox(centralWidget);
        combox1->setObjectName(QStringLiteral("combox1"));
        combox1->setGeometry(QRect(560, 50, 87, 22));
        pushBtn = new QPushButton(centralWidget);
        pushBtn->setObjectName(QStringLiteral("pushBtn"));
        pushBtn->setGeometry(QRect(550, 220, 93, 28));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        pushBtn->setText(QApplication::translate("MainWindow", "PushButton", 0));
    } // retranslateUi
